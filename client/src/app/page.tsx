...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      type: 'website',
      url: process.env.NEXT_PUBLIC_SITE_URL || 'https://mapyourideas.com',
      images: [
        {
    ...
    alternates: {
      canonical: process.env.NEXT_PUBLIC_SITE_URL || 'https://mapyourideas.com'
    }
  }
}
...
const waitlistPageData = {
  ...
  publisher: {
    ...
    logo: {
      '@type': 'ImageObject',
      url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://mapyourideas.com'}/images/logo.png`
    }
  }
}
