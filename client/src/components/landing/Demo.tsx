...
export function Demo() {
  return (
    <section id="demo" className="py-2 bg-light-background dark:bg-dark-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/jhcqzejnKWg?autoplay=0&rel=0&modestbranding=1&controls=1&showinfo=0&iv_load_policy=3&disablekb=1&fs=1&cc_load_policy=0"
            title="Product Demo"
            loading="lazy"
