...
const features = [
    ...
    },
    {
      ...
      description: 'Work together with your team, share boards, and collaborate on ideas seamlessly.',
    ...
    },
    {
      ...
      description: 'Enjoy a number of free API requests each month to explore our AI capabilities without any additional cost.',
      icon: function FreeApiIcon(props: any) {
        return (
          <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
